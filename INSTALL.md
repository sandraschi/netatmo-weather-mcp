...
4. Start the server:
   ...
   uv run python -m netatmo_weather_mcp.server

   # HTTP mode (for web dashboard)
   uv run uvicorn netatmo_weather_mcp.server:app --port 10823
   ```
5. Open `http://localhost:10823` or the frontend URL.
...
| Something else | [Open a GitHub issue](https://github.com/sandraschi/netatmo-weather-mcp/issues) |
