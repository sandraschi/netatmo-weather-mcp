    ...
    <div className="flex h-[calc(100vh-8rem)] flex-col space-y-4">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-slate-400">Ask about weather data (LLM integration placeholder)</p>
        </div>
      </div>
          ...
          <div className="flex gap-3">
            ...
            <div className="flex-1 space-y-1">
              ...
              <div className="text-sm text-slate-300 bg-blue-950/10 p-3 rounded-md border border-blue-900/30 inline-block">
                <p>Connect an LLM (e.g. via MCP) to get live answers from your Netatmo data.</p>
              </div>
            </div>
          </div>
        </CardContent>
