...
# Fleet pattern: CWD = script dir (web_sota), uv run --project $ProjectRoot so package is resolved
$backendCmd = "Set-Location '$PSScriptRoot'; uv run --project '$ProjectRoot' uvicorn netatmo_weather_mcp.web_app:app --host 127.0.0.1 --port $BackendPort --log-level info"
