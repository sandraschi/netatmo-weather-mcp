...
from netatmo_weather_mcp.core.netatmo_client import NetatmoClient, WeatherData, WeatherStation
...
def sample_weather_station() -> WeatherStation:
    ...
    return WeatherStation(
        ...
        home_name="Test Home",
        reachable=True,
        modules=[{"id": "02:00:00:12:34:57", "name": "Outdoor Module", "type": "NAModule1", "reachable": True}],
...
def mock_netatmo_client(sample_weather_station, sample_weather_data):
    ...
    client.get_station_status = AsyncMock(
        return_value={
    ...
    client.health_check = AsyncMock(return_value={"status": "healthy", "stations_count": 1, "reachable_stations": 1})
        ...
        "homes": [
            {
                ...
                "modules": [
                    {"id": "02:00:00:12:34:57", "name": "Outdoor Module", "type": "NAModule1", "reachable": True}
                ],
            }
        ]
    }
